module MaquinaComponentsHelper
  ...
  def main_icon_svg_for(name)
    ...
    when :rocket
      <<~SVG.freeze
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="">
          ...
          <path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.87 12.87 0 0 1 22 2c0 2.72-.78 7.5-6.05 11A22.4 22.4 0 0 1 12 15z"></path>
    ...
    when :pin
      ...
      SVG
    when :pin_solid
      # Compact filled pushpin — legible at small sizes (e.g. the ws-tile pin-dot).
      <<~SVG.freeze
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none" class="">
          <path d="M16 4v5l3 3v2h-6v6l-1 1-1-1v-6H5v-2l3-3V4z"></path>
        </svg>
      SVG
    when :plus
      <<~SVG.freeze
