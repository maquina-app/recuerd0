module LucideIconHelper
  def lucide_icon(name, options = {})
    ...
    when :bookmark_plus
      %(<path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" /><line x1="12" x2="12" y1="7" y2="13" /><line x1="9" x2="15" y1="10" y2="10" />)
    when :arrow_left
    ...
    %(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="#{stroke_width}" stroke-linecap="round" stroke-linejoin="round" class="#{classes}" #{attributes}>#{svg_content}</svg>).html_safe
  end
end
